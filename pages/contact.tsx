                        ...
                        <Row className={"mt-4"}>
                            <Col md={12} lg={3} className={"d-flex flex-column justify-content-between"}>
                                <Jumbotron>
                                    ...
                                    <p>
                                        See my latest experiments & projects,
                                        along with the technologies I keep up with!
                                    </p>
                            ...
                            <Col md={12} lg={6} className={"order-first order-lg-0"}>
                                <Jumbotron className={"d-flex flex-column align-items-center"}>
                                    ...
                                    <p className={"mt-2 px-3 text-center"}>
                                        ...
                                        Use them to further learn about who I am and to get in contact to go out
                                        for a coffee or to collaborate on a project!
                                    </p>
                                </Jumbotron>
                            </Col>
                            ...
                            <Col md={12} lg={3} className={"d-flex flex-column justify-content-between"}>
                                <Jumbotron>
                                    ...
                                    <p>
                                        Want to collaborate, or simply have a talk
                                        over some coffee? Shoot me an email!
                                    </p>
