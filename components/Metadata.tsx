...
const Metadata = ({ title }: MetadataProps) => {
    return (
        <Head>
            ...
            <meta name={"twitter:title"} content={"Deyby Rodriguez's Personal Website"}/>
            <meta
                name={"twitter:description"}
                content={"Deyby Rodriguez's online portfolio website, which includes personal projects, work experience, skills, and more"}
            />
